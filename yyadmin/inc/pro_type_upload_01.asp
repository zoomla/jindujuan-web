...
<div id="sponsorAdDiv" style="visibility:hidden; left: 0px; top: 0px; width: 197px; height: 13px"> 
...
<form method="post" action="pro_type_upload_02.asp" enctype="multipart/form-data" name="form2" onSubmit="initAd();" style="margin:0px">
