...
if rs.eof=false then
   news_title=rs("news_title")'/标题
   news_time=rs("news_time")'/标题
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td height="37" valign="bottom" bgcolor="#999999">&nbsp;&nbsp;&nbsp; <img src="../images/title2.gif" width="7" height="7"> 
      <font color="#990000">&nbsp;<b>新闻文本内容面板</b></font> 
  ...
  <tr> 
    <td height="162" valign="top"><br>
      <table width="85%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666" bordercolordark="#FFFFFF" class="tablebk">
        <form action="chknews_modify.asp" method="post" name="form1" onSubmit="return Checkform();">
          <tr> 
          ...
          <tr> 
            <td height="12"> <div align="right">隶属类型：</div></td>
            <td height="12"><select name="type_id" id="type_id">
                <%
			sql="select id,typename from news_type where language="&language
			rs.open sql,conn,1,1
			while not rs.eof
			%>
          ...
          <tr> 
            ...
            <td height="24"> <input name="news_time" type="text" id="news_time" value="<%=news_time %>" size="60" readonly> 
              <font color="#FF0000">*</font></td>
          </tr>
          <tr> 
            <td height="24"><div align="right">新闻标题：</div></td>
            <td height="24"><input name="news_title" type="text" id="news_title" value="<%=news_title %>" size="60"> 
              <font color="#FF0000">*</font></td>
          </tr>
          <tr> 
          ...
          <tr> 
            <td colspan="2" align="center"> <table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666" bordercolordark="#FFFFFF">
                <tr> 
                  <td height="12"><textarea name="news_content" id="news_content" style="width:100%; height:400px; visibility:hidden;"><%=news_content %></textarea></td>
                </tr>
              </table></td>
          </tr>
          <tr> 
