...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td height="37" valign="bottom" bgcolor="#999999">&nbsp;&nbsp;&nbsp; <img src="../../images/title2.gif" width="7" height="7"> 
      <font color="#990000">&nbsp;<b>栏目名称添加面板</b></font> 
  ...
  <tr> 
    <td height="162" valign="top"><br>
      <table width="80%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#666666" bordercolordark="#FFFFFF" class="tablebk">
        <form name="form1" method="post" action="news_save.asp" onSubmit="return Checkform();">
		<tr> 
          ...
          <tr> 
            ...
            <td width="81%"> <input name="typename" type="text" id="typename" size="55"> 
              <font color="#FF0000">*</font> </td>
          </tr>
          <tr> 
            <td height="33">&nbsp;</td>
            <td><input type="submit" name="Submit" value="  添加  "> <input type="button" name="Submit2" value="  返回  " onClick="javascript:history.back();">
